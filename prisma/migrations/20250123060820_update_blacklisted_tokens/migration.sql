/*
  ...
  - Added the required column `expiry_time` to the `blacklisted_tokens` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `blacklisted_tokens` ADD COLUMN `expiry_time` DATETIME(3) NOT NULL;
